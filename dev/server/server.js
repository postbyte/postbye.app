...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `${($$result.title = `<title>Sapper Fortune Template</title>`, "")}`, "")}

<article><div><h1>Welcome to your Sapper site.</h1></div></article>`;
});
...
<section class="${"cols"}"><article class="${"col"}"><h1>Blog</h1>
    ${each(posts, (post, index) => `${index ? `<hr>` : ``}
      <div class="${"post-item"}"><h2><a rel="${"prefetch"}" href="${"blog/" + escape(post.slug)}">${escape(post.title)}</a></h2>
        <p>${escape(post.excerpt)}</p>
        <div class="${"post-item-footer"}"><span class="${"post-item-date"}">— ${escape(post.printDate)}</span></div>
      </div>`)}</article></section>`;
});
...
const Bio = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div><p>This is a bio.</p></div>`;
});
...
const U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `\`
${($$result.head += `${($$result.title = `<title>${escape(post.title)}</title>`, "")}`, "")}
<section class="${"cols"}"><article class="${"col"}"><header><p>${escape(post.printDate)} ~ ${escape(post.printReadingTime)}</p>
      <h1>${escape(post.title)}</h1>
      <hr></header>
    <div class="${"container"}"><article class="${"content"}">${post.html}</article>
      <hr>
      ${validate_component(Bio, "Bio").$$render($$result, {}, {}, {})}</div></article></section>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav><div><a${add_attribute("class", segment === undefined ? "bold" : "", 0)} href="${"."}">home</a>
    <a${add_attribute("class", segment === "about" ? "bold" : "", 0)} href="${"about"}">about</a>
    <a rel="${"prefetch"}"${add_attribute("class", segment === "blog" ? "bold" : "", 0)} href="${"blog"}">blog
    </a></div></nav>`;
});
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { segment } = $$props;
	if ($$props.segment === void 0 && $$bindings.segment && segment !== void 0) $$bindings.segment(segment);
	return `<header>${validate_component(Nav, "Nav").$$render($$result, { segment }, {}, {})}</header>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main p="${"10 sm3"}">${validate_component(Header, "Header").$$render($$result, { segment }, {}, {})}

  <main py="${"4"}">${$$slots.default ? $$slots.default({}) : ``}</main>

  <footer><nav><div><a href="${"https://github.com/atav1k/sapper-fortune-template"}">Github</a>
        <a href="${"/"}">© ${escape(new Date().getFullYear())}</a></div></nav></footer></main>`;
});
...
<section class="${"cols"}"><article class="${"col"}"><h1>${escape(status)}</h1>
